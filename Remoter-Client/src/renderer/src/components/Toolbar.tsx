...
const s: Record<string, React.CSSProperties> = {
  ...
  dropItem: {
    ...
    cursor: 'pointer', whiteSpace: 'nowrap', gap: 10, fontFamily: 'inherit',
  },
  ...
  ctrlItemIcon: { fontSize: 12, width: 18, textAlign: 'center', flexShrink: 0 },
  shortcut: { fontSize: 10, color: 'var(--ov-text2)', flexShrink: 0 },
  menuSep: { height: 1, background: 'var(--ov-sep)', margin: '2px 0' },
  // shared
  sep: { width: 1, height: 14, background: 'var(--ov-sep)', margin: '0 3px', flexShrink: 0 },
  btn: {
  ...
  badge: {
    ...
    fontSize: 8, fontWeight: 700, borderRadius: 7,
    padding: '0 3px', minWidth: 12, textAlign: 'center', lineHeight: '13px',
  },
}
